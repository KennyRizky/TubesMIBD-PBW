    ...
    if($_SERVER["REQUEST_METHOD"] == "GET"){
        switch ($url) {
            ...
            case $baseURL.'/logoutAdmin';
                ...
                echo $logoutCtrl->logoutAdmin();
                header('Location: index');
                break;
            case $baseURL.'/logoutMember';
                require_once "controller/logoutController.php";
                $logoutCtrl = new logoutController();
                echo $logoutCtrl->logoutMember();
                header('Location: index');
                break;
            case $baseURL.'/logoutTeacher';
                require_once "controller/logoutController.php";
                $logoutCtrl = new logoutController();
                echo $logoutCtrl->logoutTeacher();
                header('Location: index');
                break;
        ...
        switch($url){
            ...
            case $baseURL.'/submitExam';
                ...
                break;
            case $baseURL.'/submitSignInAdmin';
                require_once "controller/signInController.php";
                $signInAdmin = new signInController();
                $signInAdmin->check_signInAdmin();
                break;
            case $baseURL.'/validateNilai';
                require_once "controller/adminController.php";
